<div class="secondary col-md-4 col-sm-12 col-xs-12 go-left">
      ...
      <div class="content">
        ...
        <div class="item row featured">
          ...
          <div class="desc col-md-8 col-sm-8 col-xs-12 go-left row">
            <h4 style="margin-top: 0px;" class="title go-text-right"><a href="<?php echo base_url().'blog/'.$post->post_slug;?>" ><?php echo character_limiter(strip_tags($bloglib->title), 20);?></a> <span class="text-warning weak"><br><?php echo $bloglib->date;?></span></h4>
          </div>
          <!--//desc-->
        </div>
        <!--//item-->
