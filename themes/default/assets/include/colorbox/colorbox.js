				...
				$(".slidebox").colorbox({rel:'group4', slideshow:true});
				$(".ajax").colorbox();
                ...
                $("#searching").autocomplete("<?php echo base_url();?>hotels/txtsearch", { selectFirst: true });
                $(".searchbar").click(function(){ $('html, body').animate({ scrollTop: $(this).offset().top - ( $(window).height() - $(this).outerHeight(true) - 90 ) / 2 }, 'slow'); }); });
	        	</script>
               <!-- ColorBox Ending -->