...
';
                ...
                $this->accounts_model->update_profile($userid);
                if (!empty ($subscribe)) {
...
<div class="alert alert-danger">Invalid file type kindly select only jpg/jpeg, png, gif file types</div>

';
                    } elseif ($result == '2') {
                        echo '

<div class="alert alert-danger">Only upto 2MB size photos allowed</div>
