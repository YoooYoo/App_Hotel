...
<input type="hidden" name="paidamount" value="<?php echo $invoice->amountPaid;?>" />
    ...
    <?php if(!empty($service)){  ?>
      ...
      if($service == "cars" && $cartrue){ ?>
        ...
        <option value="<?php echo $car->car_id;?>" <?php if($bdetails[0]->booking_item == $car->car_id){ echo "selected"; }?> > <?php echo $car->car_title;?> </option>
        <?php  } ?>
        ...
        <div class="col-md-3">
        <input class="form-control" id="totalcarprice" type="text" name="totalcarprice"  value="<?php echo $totalcarprice;?>" readonly="true">
         </div>
        </div>
        ...
        <label class="col-md-3 control-label">Per Night Price</label>
        <div class="col-md-3">
        <input class="form-control" id="cartotal" type="text" placeholder="Price" name="cartotal" value="<?php echo $carprice;?>" required>
        </div>
        </div>
   ...
   <?php  } } ?>
    ...
    <?php } ?>
      ...
      <tr style="background-color:#e7ffda" style="display:none;" id="tr_caramount">
       ...
       <td style="font-size:14px"><?php echo $app_settings[0]->currency_sign;?><span id="summarycartotal"><?php echo $totalcarprice;?></span></td>
      </tr>
      <?php } ?>
