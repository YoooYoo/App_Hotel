      ...
      <div class="modal-body">
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="panel panel-default" style="height:150px">
              <div class="panel-heading head">
                <h3 class="panel-title"><?php echo trans('0120');?></h3>
              </div>
              <div class="panel-body">
          ...
          <div class="clearfix"></div>
           <hr>
          <div class="col-md-6">
             <h4><strong><?php echo trans('076');?> #<?php echo $invoice[0]->book_itineraryid;?></strong></h4>
            <span><?php echo trans('076');?> <?php echo trans('08');?>: <?php echo pt_show_date_php($invoice[0]->book_date);?></span>
          </div>

          <div class="col-md-6">
             <h4><strong><?php echo $invoice[0]->book_hotel;?></strong></h4>
                <strong><?php echo trans('07');?> : </strong> <?php echo date("F j, Y", strtotime($invoice[0]->book_checkin));?>
                <strong><?php echo trans('09');?> : </strong> <?php echo date("F j, Y", strtotime($invoice[0]->book_checkout));?>
          </div>
            ...
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="panel-body">
                    <div class="table-responsive">
                      <table class="table table-condensed">
                        <thead>
                          <tr>
                            <td><strong><?php echo trans('046');?></strong></td>
                            <td class="text-center"><strong><?php echo trans('070');?></strong></td>
                            <td class="text-center"><strong><?php echo trans('0122');?></strong></td>
                          <!--  <td class="text-center"><strong><?php echo trans('0123');?></strong></td> -->
                       ...
                       <!--     <td class="text-center"><?php echo "room quantity";?></td>   -->
                          ...
                          <tr>
                            ...
                            <td class="no-line"></td>
                          <!--  <td class="no-line"></td> -->
                            <td class="no-line text-center">Tax & VAT</td>
                        ...
                        <!--    <td class="no-line"></td>  -->
                            ...
                            <td class="no-line text-right">
                              <h3><strong><?php echo $invoice[0]->book_total;?></strong></h3>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                ...
                <div class="panel panel-default">
                  ...
                  <p><strong><?php echo trans('0128');?></strong></p>
