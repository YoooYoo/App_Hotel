  ...
  <div class="panel panel-default">
    ...
    <div class="panel panel-default">
     ...
     <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group checkinlabel" <?php if($service == "tours"){ ?> style="display:none;" <?php } ?> >
        <label class="col-md-3 control-label"><?php echo $checkinlabel;?> </label>
        <div class="col-md-3">
        <input class="form-control dpd1" id="<?php echo $service;?>" type="text" placeholder="Date" name=""  value="" />
        </div>
        </div>
        <?php if($service != "tours"){ ?>
        <div class="form-group">
        <label class="col-md-3 control-label"><?php echo $checkoutlabel;?> </label>
        <div class="col-md-3">
        <input class="form-control dpd2" id="<?php echo $service;?>" type="text" placeholder="Date" name=""  value="" />
        </div>
        </div><?php } ?>
      ...
      if($service == "cars" && $cartrue){ ?>
        ...
        <label class="col-md-3 control-label">Per Night Price</label>
        <div class="col-md-3">
        <input class="form-control" id="cartotal" type="text" placeholder="Price" name="cartotal" value="0" required>
        </div>
        </div>
      ...
      <input type="hidden" name="tourtype" id="tourtype" value="" />
        ...
        <div class="col-md-3">
      <select class="form-control" id="maxadults">
        ...
        <div class="col-md-3">
      <select class="form-control" id="maxchild">
        ...
        <div class="col-md-3">
      <select class="form-control" id="maxinfants">
