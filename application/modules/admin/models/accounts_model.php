...
// Get all accounts active customers
    ...
    function update_profile($id, $filename = null) {
        ...
        $data = array('ai_title' => $this->input->post('title'), 'ai_first_name' => $this->input->post('fname'), 'ai_last_name' => $this->input->post('lname'),
...
// 'ai_website' => $this->input->post('website'),
        'ai_image' => $filename, 'accounts_updated_at' => $now, 'accounts_permissions' => $permissions, 'accounts_status' => $this->input->post('status'));
...
//  'ai_image' => $filename,
        'accounts_created_at' => $now, 'accounts_updated_at' => $now, 'accounts_permissions' => $permissions, 'accounts_verified' => 0, 'accounts_status' => 'no');
        $this->db->insert('pt_accounts', $data);
...
// Admin login
    function login_admin($username, $password) {
        ...
        $this->db->where('accounts_password', md5($password));
...
// Signup account
    function signup_account($type, $status) {
        ...
        $data = array('accounts_email' => $this->input->post('email'), 'accounts_password' => sha1($password), 'accounts_type' => $type, 'ai_title' => $this->input->post('title'), 'ai_first_name' => $this->input->post('firstname'), 'ai_last_name' => $this->input->post('lastname'), 'ai_city' => $city, 'ai_country' => "", 'ai_mobile' => $this->input->post('phone'), 'accounts_created_at' => $now, 'accounts_updated_at' => $now, 'accounts_status' => $status);
        $this->db->insert('pt_accounts', $data);
...
// Signup account via API
    function apisignup_account($userdata) {
        $now = date('Y-m-d H:i:s');
        $password = rand(6, 15);
        $data = array('accounts_email' => $userdata['email'], 'accounts_password' => sha1($password), 'accounts_type' => 'guest', 'ai_first_name' => $userdata['first_name'], 'ai_last_name' => $userdata['last_name'], 'ai_mobile' => $userdata['phone'], 'ai_address_1' => $userdata['address'], 'accounts_created_at' => $now, 'accounts_updated_at' => $now, 'accounts_status' => 'no');
        $this->db->insert('pt_accounts', $data);
        $id = $this->db->insert_id();
        return $id;
    }
...
//update admin notes
    ...
    function verify_account($userid) {
        ...
        $this->emails_model->email_verified($to, $pass, $name, $phone);
    }
