      ...
      // get all bookings info  by advance search for admin
        ...
        booking_total,pt_bookings.booking_deposit,pt_bookings.booking_date,pt_accounts.ai_first_name,pt_accounts.ai_last_name,pt_accounts.accounts_email');
          ...
          function do_booking($userid) {
              ...
              $tax = $this->currconverter->convertPriceFloat($bookingData->taxAmount);
              $paymethodfee = 0;
      //$this->currconverter->convertPriceFloat($bookingData->paymethodFee);
              $extrasTotalFee = $this->currconverter->convertPriceFloat($bookingData->extrasInfo->extrasTotalFee);
              ...
              $extrabedscharges = $this->currconverter->convertPriceFloat($bookingData->extraBedCharges);
      ...
      //    'booking_payment_type' => $paymethod,
                  'booking_deposit' => $deposit, 'booking_tax' => $tax, 'booking_paymethod_tax' => $paymethodfee, 'booking_extras_total_fee' => $extrasTotalFee, 'booking_curr_code' => $currCode, 'booking_curr_symbol' => $currSymbol, 'booking_extra_beds' => $extrabeds, 'booking_extra_beds_charges' => $extrabedscharges);
                  ...
                  elseif ($bookingtype == "cars") {
                      $rdata = array('booked_booking_id' => $bookid, 'booked_car_id' => $this->input->post('itemid'), 'booked_checkin' => convert_to_unix($checkin), 'booked_checkout' => convert_to_unix($checkout), 'booked_booking_status' => 'unpaid');
                      $this->db->insert('pt_booked_cars', $rdata);
                  }
      ...
      $this->emails_model->sendEmail_customer($invoicedetails,$this->data['app_settings'][0]->site_title,$this->data['app_settings'][0]->currency_sign,$this->data['app_settings'][0]->currency_code);
      $this->emails_model->sendEmail_admin($invoicedetails,$this->data['app_settings'][0]->site_title,$this->data['app_settings'][0]->currency_sign,$this->data['app_settings'][0]->currency_code);
      $this->emails_model->sendEmail_owner($invoicedetails,$this->data['app_settings'][0]->site_title,$this->data['app_settings'][0]->currency_sign,$this->data['app_settings'][0]->currency_code);
      ...
      */
      ...
      //Update booking details
          function update_booking($id) {
            ...
            $this->db->where('booking_id',$this->input->post('bookingid'));
