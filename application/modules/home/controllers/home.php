...
//        die;
    ...
    public function FactorizationMatrix()
    {
        $R = [
            [5,3,0,1],
            [4,0,0,1],
        ...
        // Khoi tao gia tri theo phan phoi chuan
        ...
        echo '<pre>';
        // Gop 2 ma tran R = P * Q
        print_r($this->matrixmult($calculatedRatingsMatrix[0], $this->transpose($calculatedRatingsMatrix[1])));
    }
 ...
 * */
    ...
    // Function phan phoi ngau (random gia tri ngau nhien) trong mang
