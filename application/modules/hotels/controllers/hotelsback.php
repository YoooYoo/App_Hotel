		...
		public function add() {
				...
				if (!empty ($addhotel)) {
						...
						if ($this->form_validation->run() == FALSE) {
								...
								$hotelid = $this->hotels_model->add_hotel();
...
if(!$this->data['addpermission'] && !$this->editpermission && !$this->deletepermission){
		...
		$output .= '<input type="hidden" name="ids_list" value="'.$ids_list.'">';
					   ...
					   //	 $datefmt = $this->input->post('dateformat');
                        ...
                        $xcrud->label('room_title','Name')->label('pt_hotels.hotel_titl','Hotel')->label('room_basic_price','Price')->label('room_quantity','Qty')->label('room_status','Status');
